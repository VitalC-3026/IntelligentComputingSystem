...
def power_difference_op(input_x,input_y,input_pow):
    with tf.Session() as sess:
        ...
        placeholder_x = tf.placeholder(np.float32, shape=input_x.shape, name="placeholder_x")
        placeholder_y = tf.placeholder(np.float32, shape=input_y.shape, name="placeholder_y")
        placeholder_z = tf.placeholder(np.float32, name="placeholder_z")
